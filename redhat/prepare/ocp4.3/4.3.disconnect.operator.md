...
storage:
    cache:
        layerinfo: inmemory
    filesystem:
        rootdirectory: /data/remote/4.3.3/registry
    delete:
        enabled: true
http:
    addr: :5443
...
--initrd-inject /data/helper-ks.cfg --extra-args "inst.ks=file:/helper-ks.cfg" 
...
export NGINX_DIRECTORY=/data/remote/4.3.3/ocp4
...
INFO Login to the console with user: kubeadmin, password: hEvkn-r9v4X-c5NQs-ayNV2
```
