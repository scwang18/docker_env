...
本文描述ocp4.3在baremental(kvm模拟)上面，静态ip安装的方法。包括operator hub步骤。
...
打包好的安装包，在这里下载(internal access only)，目前最新版本是ocp 4.3.5： https://drive.google.com/drive/u/2/folders/1Cu3qg2m4jn9psZxWHFTJFdH6ZW3O2vjR
...
```
Success
Update image:  registry.ipincloud.com:5443/ocp4/openshift4:4.3.3
Mirror prefix: registry.ipincloud.com:5443/ocp4/openshift4

To use the new mirrored repository to install, add the following section to the install-config.yaml:

imageContentSources:
- mirrors:
  - registry.ipincloud.com:5443/ocp4/openshift4
...
spec:
  ...
  sourceType: grpc
  image: docker.io/wangzheng422/operator-catalog:redhat-2020-02-29
  publisher: Red Hat
EOF
...
spec:
  ...
  sourceType: grpc
  image: docker.io/wangzheng422/operator-catalog:certified-2020-02-29
  publisher: Certified
EOF
