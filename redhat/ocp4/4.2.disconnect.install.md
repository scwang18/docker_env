本文已过期，请移步 https://github.com/wangzheng422/docker_env/blob/master/redhat/ocp4/4.2.disconnect.operator.md

# openshift 4.2 静态IP离线 baremetal 安装
...
```bash
# on vultr
yum -y install podman docker-distribution pigz
...
```
Success
Update image:  registry.ipincloud.com/ocp4/openshift4:4.2.0
...
INFO Login to the console with user: kubeadmin, password: FFt2Z-X6r2Q-euvpp-gyAJM
```
