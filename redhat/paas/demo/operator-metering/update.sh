...
update_yaml "charts/openshift-metering/values.yaml" "it-registry.ipincloud.com:5021"

update_yaml "manifests/deploy/openshift/olm/bundle/4.1/image-references" "it-registry.ipincloud.com:5021"

update_yaml "manifests/deploy/openshift/olm/bundle/4.1/meteringoperator.v4.1.0.clusterserviceversion.yaml" "it-registry.ipincloud.com:5021"
